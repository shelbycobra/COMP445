...
if [ "$1" == "1"  ]; then
    ...
    java httpc post -v localhost:8080/bin/test1 -d "hello1" -h Overwrite:true &
    java httpc post -v localhost:8080/bin/test1 -d "goodbye1" -h Overwrite:true
fi
...
if [ "$1" == "2" ]; then
    ...
    echo "hello2" > test2
    java httpc post -v localhost:8080/test2 -d "goodbye2" -h Overwrite:true &
    java httpc get -v localhost:8080/test2
fi
...
if [ "$1" == "3" ]; then
    ...
    echo -e "Running java httpc get -v localhost:8080/test3"
    echo "hello3" > test3
    java httpc get -v localhost:8080/test3 &
    java httpc get -v localhost:8080/test3
fi