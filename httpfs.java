...
public class httpfs {
    ...
    public void listen() throws IOException{
        ...
        try {
            ...
            while(true) {
                ...
                SocketClient clientThread = new SocketClient(client, this.verbose, this.root, id);
                clientThread.start();
                id++;
            }
    ...
    class SocketClient extends Thread {
        ...
        public SocketClient(Socket client, boolean verbose, String root, int id) throws IOException{
            this.client = client;
